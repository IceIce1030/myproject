         ...
         if( $roomimg->rowCount() == 0 ){ //找不到
            ...
            echo "{}";
              ...
              while ( $roomimgRow = $roomimg->fetch(PDO::FETCH_ASSOC) ){
                      $str .="<td>
                          <img style='width:133px;height:100;' src='../images/room/{$roomimgRow["roomimg_name"]}' id='img{$roomimgRow["roomimg_no"]}'>
                          <input type='file' class='updateinput' name='image' value=''>
