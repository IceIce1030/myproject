...
(function($) {
    ...
    function Plugin($container, options) {
        ...
        this.move = function(index) {
            ...
            var currentDot= this.slideCurrent;
            var puttxt;
            ...
            if(currentDot==0){
                ...
                puttxt='黏人';
                sessionStorage.personality = '黏人';
                sessionStorage.mom = 'Sara';
            }
            else if(currentDot==2){
                puttxt='害羞';
                sessionStorage.personality = '害羞';
                sessionStorage.mom = 'Judy';
            }
            else if(currentDot==3){
                puttxt='調皮';
                sessionStorage.personality = '調皮';
            ...
            currentDot = "dot-"+(parseInt(currentDot+1));
            
            $('.pet-personality').text(puttxt);
            sessionStorage.personality = puttxt;
            $('.book .step_mom .momcover').addClass('momcover-move');
            var tt = setTimeout(function(){
                $('.book .step_mom .momcover').removeClass('momcover-move');
            },1000);
            
            var MomNum=currentDot.replace('dot-','');
